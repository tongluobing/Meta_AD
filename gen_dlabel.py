...
colors1 = cm.gnuplot2(np.linspace(0, 1, 128))[40:]
...
#%%
# 亚型4类
main_nii_path = r'./results\subtype\gmv_AD\subtype0.nii'
sub_nii_pathes = [r'./results\subtype\gmv_AD\subtype1.nii',
                   r'./results\subtype\gmv_AD\subtype2.nii',
                   r'./results\subtype\gmv_AD\subtype3.nii']

mapping_cii.gmv_to_cii(main_nii_path, cmap_pos=cmap_pos, cmap_neg=cmap_neg)

_, mappable_pos, mappable_neg = mapping_cii.gmv_to_cii(main_nii_path,
                                                 vmax_neg=0, vmin_neg=-4314,
                                                 vmax_pos=1238, vmin_pos=0, 
                                                 cmap_pos=cmap_pos, cmap_neg=cmap_neg)
