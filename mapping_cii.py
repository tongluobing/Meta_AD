...
def mapping(in_path,
            ...
            command_path='H:/workspace/HCP/workbench/bin_windows64/wb_command.exe',
            mapping_method='-enclosing',
            surf_path_L='H:/workspace/HCP/fsaverage/fsaverage_LR32k/fsaverage.L.inflated.32k_fs_LR.surf.gii',
            surf_path_R='H:/workspace/HCP/fsaverage/fsaverage_LR32k/fsaverage.R.inflated.32k_fs_LR.surf.gii'):
    """
...
def ct_to_cii(in_path,
              cmap_pos=None, vmin_pos=None, vmax_pos=None, mappable_pos=None,
              cmap_neg=None, vmin_neg=None, vmax_neg=None, mappable_neg=None,
              dlabel_path='H:/workspace/HCP/fsaverage/fsaverage_LR32k/fsaverage.BN_Atlas.32k_fs_LR.dlabel.nii',
              temp_path = 'H:/workspace/HCP/rBN_Atlas_246_1mm.nii'):
    # Readin data 
